...
namespace Ilaser2.Controllers
{
    public class User_TypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Type_Id,Type_Name,Type_Description")] User_Type user_Type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Type_Id,Type_Name,Type_Description")] User_Type user_Type)
        {
            if (ModelState.IsValid)
            {
